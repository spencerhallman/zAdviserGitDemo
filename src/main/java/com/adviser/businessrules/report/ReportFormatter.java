...
/**
 * A utility class for formatting the final report.
 * It takes the aggregated {@link ReportData} and formats it into a human-readable string.
...
public final class ReportFormatter {
    ...
    /**
     * Formats the entire report by assembling various sections: header, summary,
     * results, validation messages, and the regional sales report (if applicable).
     *
     * @param reportData The data container with all the information to be reported.
     * @param runDate The date of the batch run.
     * @param isEOM A flag indicating if it is the end of the month.
     * @return A formatted string representing the complete report.
     */
